...
----
$ git clone git@github.com:${loggedUser}/drejmar1
...
{"content":"Hello, World from Neverland !"}

$ curl http://localhost:8080/api/greeting?name=Sarah
{"content":"Hello, Sarah from Neverland !"}

$ curl http://localhost:8080/api/greeting?name=Sarah&place=England
{"content":"Hello, Sarah from England !"}
----
